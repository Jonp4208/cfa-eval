...
import { Search, Plus, AlertCircle, UserCircle, Users, Loader2 } from 'lucide-react'
    ...
    <div className="p-6">
      <div className="flex flex-col gap-6">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-semibold text-gray-900">New Hire Training</h1>
          <p className="text-gray-600 text-lg">Track and manage training progress for new employees</p>
        </div>
