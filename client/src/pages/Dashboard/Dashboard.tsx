            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                <h1 className="text-2xl md:text-3xl font-bold flex items-center gap-3">
                  {t('dashboard.welcomeBack', `Welcome back, ${user?.name}!`, { name: user?.name })}
              ...
              <div className="hidden sm:flex flex-col sm:flex-row gap-3">
                ...
                >
                  ...
                  <span className="font-medium">{t('evaluations.create')}</span>
                </button>
                <button
                  onClick={handleNavigate('/disciplinary/new')}
                  className="bg-white hover:bg-white/90 text-[#E51636] flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-black/10"
                >
                  <AlertCircle className="w-5 h-5" />
                  <span className="font-medium">{t('dashboard.newIncident')}</span>
                </button>
              </div>
            </div>
          </div>
