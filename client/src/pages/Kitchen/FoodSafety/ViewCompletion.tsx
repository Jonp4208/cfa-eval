          ...
          <div className="space-y-4">
            <div className="flex flex-wrap gap-4 items-center justify-between">
              ...
              <div className="space-y-1 text-right">
                ...
                <p className="text-sm text-[#27251F]/60">
                  By: {typeof completion.completedBy === 'string' 
                    ? completion.completedBy 
                    : (completion.completedBy as { name: string }).name}
                </p>
              </div>
            </div>
          ...
          <CardContent className="p-6 sm:p-8">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm text-[#27251F]/60">
                <p>Reviewed by: {typeof completion.reviewedBy === 'string' 
                  ? completion.reviewedBy 
                  : (completion.reviewedBy as { name: string }).name}</p>
