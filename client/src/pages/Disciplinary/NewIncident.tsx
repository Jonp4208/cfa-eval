        ...
        <div className="bg-gradient-to-r from-[#E51636] to-[#DD0031] rounded-[20px] p-6 md:p-8 shadow-xl relative overflow-hidden">
          <div className="relative">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                <h1 className="text-3xl md:text-[40px] font-bold text-white leading-tight">New Team Discipline</h1>
                <p className="text-white/80 mt-2 text-base md:text-lg">Document a new disciplinary incident</p>
              </div>
              <Button
                variant="ghost"
