...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 content-padding-ios">
      {/* Mobile Header */}
      ...
      {isMobileMenuOpen && (
        <>
          {/* Backdrop */}
          <div
            className="min-[938px]:hidden fixed inset-0 bg-gray-800 bg-opacity-50 z-40 transition-opacity"
            aria-hidden="true"
          />
          {/* Menu Panel */}
          <div
            ref={menuRef}
            className="min-[938px]:hidden fixed top-0 right-0 bottom-0 w-64 bg-white shadow-lg z-50 transform transition-transform duration-200 ease-in-out"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            <div className="border-b">
              <div className="p-4">
                <h2 className="font-bold text-[#27251F]">{t('common.notifications')}</h2>
              </div>
              <NotificationList
                onDismiss={() => {
                  const fetchNotifications = async () => {
            ...
            <div className="py-2 overflow-y-auto momentum-scroll custom-scrollbar h-[calc(100vh-64px)]">
                      ...
                      <div key={item.href}>
                        <button
                          ...
                          className={cn(
                            ...
                            activeSubmenu === item.label ? "bg-red-50" : "hover:bg-gray-50"
                          )}
                        >
                          <div className="flex items-center gap-3">
                            <Icon className={cn(
                              "w-5 h-5",
                              activeSubmenu === item.label ? "text-red-600" : "text-gray-500"
                            )} />
                            <span className={cn(
                              "text-base",
                              activeSubmenu === item.label ? "text-red-600" : "text-gray-900"
                            )}>
                              {item.label}
                            </span>
                          </div>
              ...
              <div className="border-t mt-4 pt-4">
                ...
                <button
                  ...
                  className="w-full px-4 py-3 flex items-center gap-3 text-gray-900 hover:bg-gray-50 min-h-[44px]"
                >
